...
#define TASK_TCBPOOLADDRESS     0x900000
...
#define TASK_MAXREADYLISTCOUNT  6

#define TASK_FLAGS_HIGHEST            5
#define TASK_FLAGS_HIGH               4
#define TASK_FLAGS_MEDIUM             3
#define TASK_FLAGS_LOW                2
